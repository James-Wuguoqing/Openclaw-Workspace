...
- Smart behavior rule: open actions should first check whether the exact URL is already open; close actions should first check whether matching tabs exist
